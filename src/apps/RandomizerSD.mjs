export default class RandomizerSD {
    static syllabes = [
        ...
        [
            ...
            "dal", "del", "dil", "dul",
            "k",
            "la", "lan", "lann", "len", "lenn", "lin", "lyn", "lynn", "lon", "lun",
            "las", "les", "lys", "los", "lus",
            "lur", "lon", "lyn", "len",
            "lian", "lien", "lion", "liun", "lorn",
            "na", "nar", "ne", "ni", "no", "nor", "nu",
            "nd",
            "orn",
            "rak", "ran", "ren", "ron", "run",
            "ral", "rel", "ril", "ryl", "rol", "rul",
            "rian", "rien", "rin", "rion", "riun",
            "wen", "wan",
            "zal", "zel", "zan", "zen", "zin", "zyn", "zon",
            "zar", "zer", "zir", "zor", "zur",
        ]
    ];
