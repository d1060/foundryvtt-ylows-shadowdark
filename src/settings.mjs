...
export default function registerSystemSettings() {
	...
	//  DAMAGE TARGETING
	// ------------------
	game.settings.register("shadowdark", "enableTargetingDamage", {
		hint: "SHADOWDARK.settings.enable_targeting_damage.hint",
		name: "SHADOWDARK.settings.enable_targeting_damage.name",
		scope: "world",
		config: true,
		default: true,
		type: Boolean,
	...
	// ---------------
	//
	game.settings.register("shadowdark", "use2d10", {
		name: "SHADOWDARK.settings.use_2d10.name",
		hint: "SHADOWDARK.settings.use_2d10.hint",
		scope: "world",
		type: Boolean,
		config: true,
		default: false,
	...
	game.settings.register("shadowdark", "useFixedHP", {
		name: "SHADOWDARK.settings.use_fixed_hp.name",
		hint: "SHADOWDARK.settings.use_fixed_hp.hint",
		scope: "world",
		config: true,
		default: 0,
		type: Number,
		choices: {
			0: "SHADOWDARK.settings.use_fixed_hp.option0",
	...
	// -------------------
	//
	game.settings.register("shadowdark", "use_coreSpellcasting", {
		name: "SHADOWDARK.settings.use_coreSpellcasting.name",
		hint: "SHADOWDARK.settings.use_coreSpellcasting.hint",
		scope: "world",
		type: Boolean,
		config: true,
		default: true,
	...
	// -------------------
	//  Seirizia Spellcasting
	// -------------------
	//
	game.settings.register("shadowdark", "use_seiriziaSpellcasting", {
		name: "SHADOWDARK.settings.use_seiriziaSpellcasting.name",
		hint: "SHADOWDARK.settings.use_seiriziaSpellcasting.hint",
		scope: "world",
		type: Boolean,
		config: true,
		default: false,
	...
	// -------------------
	//  Britannian Rune Magic
	// -------------------
	//
	game.settings.register("shadowdark", "use_britannianRuneMagic", {
		name: "SHADOWDARK.settings.use_britannianRuneMagic.name",
		hint: "SHADOWDARK.settings.use_britannianRuneMagic.hint",
		scope: "world",
		type: Boolean,
		config: true,
		default: false,
	...
	// -------------------
	//
	game.settings.register("shadowdark", "rollLoot", {
		name: "SHADOWDARK.settings.rollLoot.name",
		hint: "SHADOWDARK.settings.rollLoot.hint",
		scope: "world",
		type: Object,
		config: false,
		default: {},
